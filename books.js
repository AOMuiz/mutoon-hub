export const MUTOONS = [
  ...
  },
  {
    ...
    author: "Imam Barbahaaree",
    image: require("./assets/sharhsunnah.png"),
    summary:
      "The author of this book is al-Barbahāree, and his name is: al-Hasan bin ‛Alī bin Khalaf al-Barbahāree, this title being an affiliation to “Barbahār” which is a type of medicine[1], so perhaps he used to work in the field of medicines or sell it. He was from the major Hanbalee scholars taking knowledge from those who studied under Imām Ahmad bin Hanbal, such as al-Marroozee[2] and others. He studied thoroughly, and delved deeply into knowledge. He acquired the ‛aqīdah, fiqh and other knowledge from the great scholars[3]. The title of the book is Sharh as-Sunnah, i.e. Explanation of the Sunnah – the intent of the term Sunnah here is The Path of the Messenger. The intent here is not that of the terminology employed by the Scholars of Hadīth who state: “The Sunnah is whatever is affirmed upon the Prophet of statements, actions or tacit approvals,” rather the intent is more general, that being: The Path of the Messenger, The Path of his Companions and the Path of the Pious Predecessors (as-Salaf as-Sālih) – and this is the Sunnah that has been transmitted and passed down, whether it be in belief, in worship, in fiqh, or in manners and ettiquette. All of this is referred to as the Sunnah in a general sense.",
  },
  {
